...
settings <- list(
	...
	pp_bandwidth_Percent = 25,		 		## if fewer wavelengths than the bandwidth specified above in pp_bandwidth are present, how many percent of the (few) wavelengths should be used as bandwidth
	...
	plsr_univMaxNcomp = 30,					## the universal upper limit of possible components
	...
	aqg_nCoord = 12,	 					## only applies to the 1st overtone: how many coordinates to plot (can be 12 or 15)
