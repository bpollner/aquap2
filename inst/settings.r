...
stn <- list(
	...
	noi_addMode = "sdNorm", 				## the mathematical procedure to add noise to the data, possible values are 'sdNorm' for the standard-deviation based method with normal distribution sampling, sdUnif for the standard-deviation based method with uniform distribution sampling, and 'extrema' for the extrema-based method. Please see ?noise_procedures for further details.
	noi_sampleSize = 500, 					## for the two random modes, the number of values (lying within the noise-distribution) to be generated, from which then the random sample is taken. (Factory default is 500.)
	noi_sdNormHalfOnly = TRUE, 				## if, in mode sdNorm, only the half of the standard deviation should be used for calculating the random values. 
