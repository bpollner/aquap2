...
expName <- "2gr 2class4-2 1subclass"						## the name of the experiment
...
columnNamesL2 <- c("C_source", "C_DELETE")					## "DELETE" is the default character for those columns that, after the generation of the sample list, should be omitted
...
L2  <- list(list(c("A", "D", "CH"), c("A", "D", "CH"), c("CH", "F", "N"), c("CH", "F", "N", "D", "A")), list("", ""))
###
