...
expName <- "KCl-Dilutions extended"		## the name of the experiment
...
columnNamesL2 <- c("Y_Conc", "C_Procedure")	## "DELETE" is the default character for those columns that, after the generation of the sample list, should be omitted
...
L2  <- list(list(as.character(seq(0.1,1, by=0.1)), as.character(seq(0.01, 0.1, by=0.01)), as.character(seq(0.001, 0.01, by=0.001))), list(list(paste0("procedure_", c("A", "B", "C"))), list(paste0("procedure_", c("A", "B", "C"))))) 
###
