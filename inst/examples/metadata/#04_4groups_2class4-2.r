...
expName <- "4gr 2class4-2"						## the name of the experiment
...
L1  <- list(list(c("Pinoir", "Aquavit", "Fountainbleu", "Ramedi")), list(c("sparkling", "still"))) 	## Please look at the vignette 'Examples for Experiment-Design' for more information on the use of the arguments L1 and L2.
L2  <- list(list(c(rep("-", 4))), list(c(rep("-", 2))))
###
