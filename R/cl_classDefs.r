...
setClass("aquap_data", slots=c(metadata="list", anproc="apNull", mergeInfo= "melaNull", calcVarInfo="listNull", colCopyInfo="charNull", ncpwl="numeric", version="character"), contains="data.frame")
