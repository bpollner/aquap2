...
#' dataset_3 <- getCubeDataset(cube, 3)
#' dataset_3
#' str(dataset_3)
#' }
...
#' @export
getCubeDataset <- function(cube, index) {
...
#' cube <- gdmm(fd)
#' # assumes that in the analysis procedure we have a split variable defined.
#' fd_3_pca <- getCubeModel(cube, 3)
#' str(fd_3_pca)
#' fd_2_pls <- getCubeModel(cube, 2, "pls")
#' str(fd_2_pls)
#' }
#' @seealso \code{\link{do_emsc}} 
#' @family Extract Elements
#' @export
getCubeModel <- function(cube, index, what="pca") {
