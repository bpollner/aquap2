...
Once your data are imported into the standard dataset of `aquap2`, you can use the analysis procedure `anProc.r` to split up and group the data (**"splice datasets"**), and then use the implemented methods and tools to **analyse** your data.
